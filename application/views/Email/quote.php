                            ...
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    My name is  <?php echo $data['name']?>
                                                    and l was Inquiring for a Quote
                                                    <br>
                                                    my email address is <?php echo $data['email']?>
                                                    my Phone number is <?php echo $data['phone']?>
                                                    and am from  <?php echo $data['city']?>
                                ...
                                <tr>
                                    <td valign="top" class="footer-cell">
                                        <h4></h4>
                                        <i></i><br>
                                        Please do not reply to this email. If you have received this email by mistake, please contact our support team on <a href="mailto: <?php echo $data['support'] ?>"><?php echo $data['support']?>"</a>.<br>
                                        Powered by <a href="http://dmi.co.za/" target="_blank">DMI MULTI INVESTMENTS (PTY)</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
